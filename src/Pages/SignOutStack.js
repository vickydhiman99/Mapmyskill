...
const SignOutStack = () => {
  ...
  return (
    <div id="signoutstack" className='container form-group signoutstack mt-5'>
      <input className='form-control my-2' value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder='enter email' />
